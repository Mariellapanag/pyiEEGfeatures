...
def EEG_PyWelch(EEGdata, srate, which_channel, butter_cutoff, butter_order, frange_bands, winLength, overlap, notch, notch_freq, quality_factor):
    ...
    if notch == True:
        # Notch filter
        notched_data1 = iirnotch_filter(srate, notch_freq[0], quality_factor, EEGdata_Channel[partnonNaN])
