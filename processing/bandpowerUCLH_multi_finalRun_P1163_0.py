...
from pyiEEGfeatures.Welch_NaN_customWelch import *
...
def bandpower_process(EEGdata, fs, badch_indx):
    ...
    list_all = EEG_Python_Welch_allChannels_custom(EEGdata, badch_indx, fs, frange_bands,
...
raw_files = os.listdir(raw_data_path)[0:259]
